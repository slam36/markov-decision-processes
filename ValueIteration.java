...
public class ValueIteration extends DynamicProgramming implements Planner {
	 ...
	 */
	public void runVI() throws FileNotFoundException{
		...
		try {
			int i;
			// PrintWriter writer = new PrintWriter("gridWorldVI.txt");
			PrintWriter writer = new PrintWriter("level3blockdudeVI.txt");
